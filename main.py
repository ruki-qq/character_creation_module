...
def attack(char_name: str, char_class: str) -> str:
    """Calculate damage inflicted on enemy.

    Keyword arguments:
    char_name -- player's character name
    char_class -- player's character class
    """
...
def start_training(char_name: str, char_class: str) -> str:
    """Start training for player character.
...
def choice_char_class() -> str:
    """Choose class for player character."""
    approve_choice: str = ''
    char_class: str = ''
